...
local calcite_lined_pipe_recipe = util.table.deepcopy(data.raw.recipe.pipe)
calcite_lined_pipe_recipe.name = "afi_calcite-lined-pipe"
calcite_lined_pipe_recipe.enabled = false
calcite_lined_pipe_recipe.ingredients = {
  { type = "item", name = "afi_steel-pipe", amount = 1 },
  { type = "item", name = "calcite", amount = 1 },
}
calcite_lined_pipe_recipe.results = {
  { type = "item", name = "afi_calcite-lined-pipe", amount = 1 },
}
data:extend({ calcite_lined_pipe_recipe })

local calcite_lined_pipe_to_ground_recipe = util.table.deepcopy(data.raw.recipe["pipe-to-ground"])
calcite_lined_pipe_to_ground_recipe.name = "afi_calcite-lined-pipe-to-ground"
calcite_lined_pipe_to_ground_recipe.enabled = false
calcite_lined_pipe_to_ground_recipe.ingredients = {
  { type = "item", name = "afi_steel-pipe-to-ground", amount = 2 },
  { type = "item", name = "calcite", amount = 2 },
}
calcite_lined_pipe_to_ground_recipe.results = {
  { type = "item", name = "afi_calcite-lined-pipe-to-ground", amount = 2 },
}
data:extend({ calcite_lined_pipe_to_ground_recipe })

local calcite_lined_pump_recipe = util.table.deepcopy(data.raw.recipe.pump)
calcite_lined_pump_recipe.name = "afi_calcite-lined-pump"
calcite_lined_pump_recipe.enabled = false
calcite_lined_pump_recipe.ingredients = {
  { type = "item", name = "afi_steel-pump", amount = 1 },
  { type = "item", name = "calcite", amount = 2 },
}
calcite_lined_pump_recipe.results = {
  { type = "item", name = "afi_calcite-lined-pump", amount = 1 },
}
